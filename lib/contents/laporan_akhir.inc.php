<?php
$info = __('Submission of Student Final Report 2019');
    ...
    <div class="container">
      <div class="row">
        <div class="col">
          ...
          <p><?php echo __('Students who will submit the Final Report (PKL Report / Final Project / Thesis / Thesis) 2019 at UPT Library, please complete the data independently on the following link. Charging can be done using a PC or Android phone.'); ?></p>
