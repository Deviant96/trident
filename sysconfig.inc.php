...
$sysconf['custom_baseurl']="http://".$_SERVER['SERVER_NAME'].dirname($_SERVER["REQUEST_URI"].'?').'/';
...
// Captcha settings for Member Register
$sysconf['captcha']['register']['enable'] = true; // value can be 'true' or 'false'
$sysconf['captcha']['register']['type'] = 'recaptcha'; // value can be 'recaptcha' (at this time)
if ($sysconf['captcha']['register']['enable']) {
    include_once LIB.$sysconf['captcha']['register']['type'].DS.'register_settings.inc.php';
}
...
if (!defined('DB_NAME')) { define('DB_NAME', 'mirx3725_pnj'); }
if (!defined('DB_USERNAME')) { define('DB_USERNAME', 'mirx3725_pnj-user'); }
if (!defined('DB_PASSWORD')) { define('DB_PASSWORD', 'PqZO5nDp%Wkk'); }
// database connection
